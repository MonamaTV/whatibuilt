          ...
          {addedSocials.map((social) => {
            ...
            return (
              <button
                ...
                className="border disabled:bg-zinc-800 disabled:text-zinc-600 disabled:cursor-not-allowed border-zinc-300 text-zinc-700 px-3 py-2 text-sm mr-2 rounded-lg flex flex-row items-center justify-center gap-x-2 dark:text-zinc-200 hover:bg-primary hover:text-zinc-200 md:w-44 w-full"
              >
                <Image
                  height={20}
                  width={20}
