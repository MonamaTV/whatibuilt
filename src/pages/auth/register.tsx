      ...
      {providers &&
        Object.values(providers).map((provider) => (
          <div
            ...
            className="px-3 py-3 border border-zinc-300 text-zinc-900 hover:cursor-pointer w-80 md:w-96 text-center text-sm flex items-center space-x-2 justify-center hover:bg-zinc-50 dark:text-zinc-100 hover:text-zinc-900"
          >
            <Image
